...
def browse_client():
    ...
    if count1 == 2:
        ...
        print ("Seaarching on:", subclientId, backupsetId, backupsetName, instanceId, applicationId, clientId, clientName)
        ...
        print ("Searching on::", subclientId, backupsetId, backupsetName, instanceId, applicationId, clientId, clientName)
...
def restore_data(c,os,from_time,to_time,restore_file2):
    ...
    print ("File backed up date:", backup_time)
    print ("================================================================")
    print ("================================================================")
